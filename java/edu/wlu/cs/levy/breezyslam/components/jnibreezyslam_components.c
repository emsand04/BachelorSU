...
JNIEXPORT void JNICALL _Java_edu_wlu_cs_levy_breezyslam_components_Map_init (JNIEnv *env, jobject thisobject, jint size_pixels, jdouble size_meters)
{
...
JNIEXPORT jstring JNICALL _Java_edu_wlu_cs_levy_breezyslam_components_Map_toString (JNIEnv *env, jobject thisobject)
{
...
JNIEXPORT void JNICALL _Java_edu_wlu_cs_levy_breezyslam_components_Map_get (JNIEnv *env, jobject thisobject, jbyteArray bytes)
{
    map_t * map = cmap_from_jmap(env, thisobject);
...
JNIEXPORT void JNICALL _Java_edu_wlu_cs_levy_breezyslam_components_Map_update (JNIEnv *env, jobject thisobject, 
            jobject scanobject, 
...
JNIEXPORT void JNICALL _Java_edu_wlu_cs_levy_breezyslam_components_Scan_init (JNIEnv *env, jobject thisobject, 
                            jint span,
                            jint scan_size,
...
JNIEXPORT jstring JNICALL _Java_edu_wlu_cs_levy_breezyslam_components_Scan_toString (JNIEnv *env, jobject thisobject)
{
...
JNIEXPORT void JNICALL _Java_edu_wlu_cs_levy_breezyslam_components_Scan_update (JNIEnv *env, jobject thisobject, 
                            jintArray lidar_mm,
                            jdouble hole_width_mm,
