...
public class Scan
{
    ...
    {
        try {
            System.load("C:\\Users\\Emma\\Desktop\\BreezySLAM-master\\java\\edu\\wlu\\cs\\levy\\breezyslam\\components\\libjnibreezyslam_components.dll");
     ...
     * @param lidar_mm
     * @param velocities_dtheta_degrees
     * @param hole_width_mm
     * @param velocities_dxy_mm
     */
...
// 
    ...
    */
    ...
    public void update(float [] scanvals_mm, double hole_width_millimeters, Velocities velocities){
        this.update(scanvals_mm, hole_width_millimeters, velocities.dxy_mm, velocities.dtheta_degrees);
    }
