...
JNIEXPORT void JNICALL _Java_edu_wlu_cs_levy_breezyslam_algorithms_RMHCSLAM_init (JNIEnv *env, jobject thisobject, jint random_seed)
{
    ptr_to_obj(env, thisobject, random_new(random_seed));
}

JNIEXPORT jobject JNICALL _Java_edu_wlu_cs_levy_breezyslam_algorithms_RMHCSLAM_positionSearch (JNIEnv *env, jobject thisobject, 
